            ...
            <div class="col-xl-6 col-md-10">
              <div class="login_wrap">
                <div class="padding_eight_all bg-white">
                  ...
                  <form method="post" action="inclouds/loginproccess.php">
                      <?php if(isset($_GET['register']) && $_GET['register'] == 'failed'){ ?>
                      <div class="alert alert-danger">  ایمیل یا رمز اشتباه است</div>
                      <?php }?>
                      ...
                      <div class="chek-form">
                        <div class="custome-checkbox">
                          ...
                          <label class="form-check-label" for="exampleCheckbox1"
                            ><span>مرا به خاطر بسپار</span></label
                          >
                        </div>
                      </div>
                  ...
                  <div class="form-note text-center">
                    حساب ندارید؟ <a href="signup.php">اکنون ثبت نام کنید</a>
                  </div>
                </div>
              </div>
            </div>
