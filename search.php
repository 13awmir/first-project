...
if (session_status() == PHP_SESSION_NONE) {
    ...
    $search_query = "SELECT * FROM products_db WHERE name LIKE '%$string%' OR tozihat LIKE '%$string%'";
                ...
                <div class="row g-0">
                    <div class="col-sm-5">
                        <div
                            ...
                            data-img-src="assets/images/popup_img.jpg"></div>
                    </div>
                    <div class="col-sm-7">
                        <div class="popup_content">
                            <div class="popup-text">
                                <div class="heading_s4">
                                    <h4>عضو شوید و 25% تخفیف بگیرید</h4>
                                </div>
                                <p>
                                    برای دریافت به روز رسانی در مورد محصولات جدید در خبرنامه
                                    مشترک شوید.
                                </p>
                            </div>
                            <form method="post">
                            ...
                            <div class="chek-form">
                                <div class="custome-checkbox">
                                    ...
                                    ><span
                                        >دیگر این پنجره بازشو نشان داده نشود!</span
                                        ></label
                                    >
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product.php?link<?php echo $search['link'] ?>">
                                            <img
                                                src="uploads/<?php echo $search['photo'] ?>"
                                                alt="product_img1" />
                                        </a>
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title">
                                            <a href="shop-product.php?link=<?php echo $search['link'] ?>"
                                            ><?php echo $search['name']?></a
                                            >
                                        </h6>
                                        <div class="product_price">
                                            <span class="price"><?php echo number_format($search['price']) ?></span>
                                            <del>$55.25</del>
                                            <div class="on_sale">
                                                <span>35% تخفیف</span>
                                            </div>
